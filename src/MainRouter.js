...
import ComidaPersonalizada from './components/Alimentos/Comidas/ComidaPersonalizada';
import CrearComida from './components/Alimentos/Comidas/CrearComida';
...
import CalendarIntro from './components/Informes/CalendarIntro';
import CalendarPage from './components/Informes/RegistroTodo/CalendarPage';
...
import RegistroSueno2 from './components/Informes/RegistroSueno/RegistroSueno2';
import RegistroFarmacos2 from './components/Informes/RegistroFarmacos/RegistroFarmacos2';
    ...
    <Router>
      <Routes>
        ...
        <Route element={< PrivateLayout />}   >
          ...
          <Route path='/alimentos/comidas/comidapersonalizada'   element= {  <  ComidaPersonalizada   />   }   />
          <Route path='/alimentos/comidas/crearcomida'  element= {  <  CrearComida   />   }     />
          ...
          <Route path='/calendarintro'  element= {  < CalendarIntro    />   }     />
          <Route path='/registrotodo/calendarpage'  element=  {  < CalendarPage   />}   />
          ...
          <Route path='/registrosueno/registrosueno2'   element=  {  < RegistroSueno2   />  }   />
          <Route path='/registrofarmacos/registrofarmacos2'  element= {  < RegistroFarmacos2  />  }     />
