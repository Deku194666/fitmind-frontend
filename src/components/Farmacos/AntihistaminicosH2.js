...
function AntihistaminicosH2() {
  ...
  return (
    <div className="h2gen-detail">
      <p className="h2gen-title">Antihistamínicos H2</p>

      <p className="h2gen-subtitle">📌 Introducción</p>
      <p className="h2gen-text">
      ...
      <p className="h2gen-subtitle">🧪 Mecanismo de Acción</p>
      <ul className="h2gen-list">
      ...
      <p className="h2gen-subtitle">📋 Indicaciones Principales</p>
      <ul className="h2gen-list">
      ...
      <p className="h2gen-subtitle">💊 Ejemplos Comunes</p>
      <div className="h2gen-table-wrapper">
        <table className="h2gen-table">
          <thead>
            <tr>
              <th>Fármaco</th>
          ...
          <tbody>
            <tr>
              ...
              <td>Retirada del mercado en muchos países</td>
            </tr>
            <tr>
              <td>Famotidina</td>
              <td>20–40 mg cada 12-24 h</td>
              <td>Mejor tolerada que ranitidina</td>
            </tr>
            <tr>
              <td>Cimetidina</td>
              <td>400–800 mg cada 12 h</td>
              <td>Interacciones medicamentosas frecuentes</td>
            </tr>
          </tbody>
        </table>
      </div>

      <p className="h2gen-subtitle">⚠️ Efectos Adversos</p>
      <ul className="h2gen-list">
      ...
      <p className="h2gen-subtitle">🔄 Contraindicaciones</p>
      <ul className="h2gen-list">
      ...
      <p className="h2gen-subtitle">📉 Interacciones Relevantes</p>
      <ul className="h2gen-list">
      ...
      <p className="h2gen-subtitle">📚 Recomendaciones Clínicas</p>
      <ul className="h2gen-list">
