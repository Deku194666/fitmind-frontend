  ...
  return (
    <div className="fxh-detail55">
      ...
      <ul className="fxh-list">
        ...
        <li><strong>1977:</strong>  <Link to="/farmacos/farmacos2/metformina"> Metformina </Link> aprobada ampliamente.</li>
      ...
      <div className="fxh-table-wrapper">
        <table className="fxh-table">
          ...
          <tbody>
            <tr>
              <td>Biguanidas</td>
              <td>   <Link to="/farmacos/farmacos2/metformina"> Metformina </Link>  </td>   
      ...
      <ul className="fxh-list">
        <li><strong>Estatinas:</strong>  <Link to="/farmacos/farmacos2/atorvastatina">  Atorvastatina </Link> (↓ LDL).</li> 
      ...
      <ul className="fxh-list">
        <li><strong>   <Link to="/ecnt/hipotiroidismo">Hipotiroidismo:</Link> </strong> Levotiroxina.</li>  
        <li><strong> <Link to="/ecnt/hipertiroidismo">Hipertiroidismo:</Link>  </strong> Metimazol.</li>
      </ul>

      <p className="fxh-subtitle">⚠️ Efectos Adversos Claves</p>
      <ul className="fxh-list">
        <li><strong> <Link to="/farmacos/farmacos2/metformina"> Metformina:</Link></strong> Trastornos gastrointestinales.</li>
