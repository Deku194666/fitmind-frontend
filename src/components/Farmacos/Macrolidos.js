...
function Macrolidos() {
  ...
  return (
    <div className="ma-detail">
      <p className="ma-title">Macrólidos</p>

      <p className="ma-subtitle">📌 Introducción</p>
      <p className="ma-text">
      ...
      <p className="ma-subtitle">🧪 Mecanismo de Acción</p>
      ...
      <p className="ma-subtitle">📋 Indicaciones Principales</p>
      <ul className="ma-list">
      ...
      <p className="ma-subtitle">💊 Ejemplos Comunes</p>
      <div className="ma-table-wrapper">
        <table className="ma-table">
          ...
          <tbody>
            <tr>
              <td>Azitromicina</td>
              <td>500 mg el primer día, luego 250 mg/día por 4 días</td>
              <td>68 horas</td>
            </tr>
            <tr>
      ...
      <p className="ma-subtitle">⚠️ Efectos Adversos</p>
      <ul className="ma-list">
      ...
      <p className="ma-subtitle">🔄 Contraindicaciones</p>
      <ul className="ma-list">
      ...
      <p className="ma-subtitle">📉 Interacciones Relevantes</p>
      <ul className="ma-list">
      ...
      <p className="ma-subtitle">📚 Recomendaciones Clínicas</p>
      <ul className="ma-list">
