  ...
  return (
    <div className="fxh-detail84">
      ...
      <p className="fxh-text">
        ...
        <Link to="/ecnt/osteoporosis" > Osteoporosis</Link>, enfermedad de Paget y otras patologías que afectan la densidad mineral ósea.
      ...
      <ul className="fxh-list">
        <li>
          <Link to="/ecnt/osteoporosis">
            Osteoporosis
          </Link> posmenopáusica o senil
        </li>
        <li> 1) Prevención de fracturas osteoporóticas</li>
        <li> 2) Enfermedad de Paget ósea</li>
        <li> 3) Osteogénesis imperfecta (algunos casos)</li>
        <li> 4) Hipercalcemia maligna</li>
      </ul>
