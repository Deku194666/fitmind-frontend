...
function Examenes() {
  ...
  return (
    <div className="examenes-container">
      <NavBarExamen />
      <p className='p130'> Exámenes Médicos </p>
      <p className='p140'>Introducción📌 </p>
      <p className='p151'> Los <strong> Exámenes Médicos </strong> son herramientas fundamentales para evaluar el estado de salud de una persona,
      ...
      <p className='p140'> Exámenes 🧬 </p>
      <p className='p151'> En esta sección encontraras los tipos de exámenes que hay para el diagnostico y tratamiento de enfermedades, 
