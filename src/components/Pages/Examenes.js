...
function Examenes() {
  ...
  return (
    <div className="ecnt-detail">
      ...
      <p className='p150' style={{ width: '78rem', marginLeft: '0.5rem', fontSize: '2rem',    }}>  Los <strong> Exámenes Médicos </strong> son herramientas fundamentales para evaluar el estado de salud de una persona,
      ...
      <p className='p150' style={{ width: '78rem', marginLeft: '0.5rem', fontSize: '2rem',    }}> En esta sección encontraras los tipos de exámenes que hay para el diagnostico y tratamiento de enfermedades, 
