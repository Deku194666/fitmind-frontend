...
function RegistroElongacion2() {
  ...
  useEffect(() => {
    ...
    // 🔁 Auto-refresco al registrar una sesión de elongación
    const onNuevo = (e) => {
      if (!e?.detail?.tipo || e.detail.tipo === "elongacion") {
        fetchRegistros();
      }
    };
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <p className="Par1">📊 Análisis de Elongación</p>
      <p className="Par2">
        Visualiza la evolución de tus sesiones de estiramiento y movilidad.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Tiempo */}
        <Card>
          <p className="ParGrafico">⏱️ Tiempo de elongación (min)</p>
        ...
        {/* Calorías */}
        <Card>
          <p className="ParGrafico">🔥 Calorías estimadas (kcal)</p>
          <ResponsiveContainer width="92%" height={350}>
            <LineChart data={data}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="fechaLabel" />
        ...
        {/* Intensidad */}
        <Card>
          <p className="ParGrafico">⚖️ Intensidad (kcal/min)</p>
          <ResponsiveContainer width="92%" height={350}>
            <LineChart data={data}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="fechaLabel" />
