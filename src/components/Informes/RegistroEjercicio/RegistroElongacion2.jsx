...
import { FaChild, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroElongacion2() {
  ...
  useEffect(() => {
    ...
    fetchRegistros();
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo==="elongacion") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo27">🧘‍♂️ Análisis de Elongación</p>

      <div className="intro">
        Revisa tus sesiones de elongación: tiempo dedicado, calorías quemadas e intensidad promedio.
      </div>

      <div className="resumen27">
