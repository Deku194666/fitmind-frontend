...
import { FaBolt, FaClock, FaFire, FaChartLine, FaStar } from "react-icons/fa";
import "./RegistroSprints2.css";
...
function RegistroSprints2() {
  ...
  useEffect(() => {
    ...
    const fetchRegistros = async () => {
      try {
        ...
        const res = await axios.get(
          `${process.env.REACT_APP_API_URL}/api/sprints/historial/${usuario_id}`,
    ...
    const onNuevo = (e) => {
      if (!e?.detail?.tipo || e.detail.tipo === "sprints") fetchRegistros();
    };
  ...
  return (
    <div className="registro-container">
      <p className="titulo">⚡ Análisis de Sprints</p>

      <div className="intro">
        Analiza tus sesiones de sprint: duración total, calorías quemadas
        e intensidad promedio. Ideal para medir explosividad y rendimiento anaeróbico.
      </div>

      <div className="resumen">
        <MetricCard icon={<FaBolt size={28} color="#f59e0b" />}>
        ...
        <div className="chart-card">
          ...
          <ResponsiveContainer width="100%" height={400}>
            <LineChart data={data}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="minutos" stroke="#f59e0b" dot={{ r: 3 }} activeDot={{ r: 6 }} />
            </LineChart>
          </ResponsiveContainer>
        </div>
...
export default RegistroSprints2;
