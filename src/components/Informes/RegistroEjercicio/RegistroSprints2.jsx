...
import { FaBolt, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroSprints2() {
  ...
  useEffect(() => {
    ...
    fetchRegistros();
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo === "sprints") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo22">⚡ Análisis de Sprints</p>

      <div className="intro">
        Analiza tus sesiones de sprint: duración total, calorías quemadas e intensidad promedio.
      </div>
