...
import { FaFistRaised, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroBoxeoSaco2() {
  ...
  useEffect(() => {
    ...
    fetchRegistros();
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo==="boxeo-saco") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo24">🥊 Análisis de Boxeo de Saco</p>

      <div className="intro">
        Analiza tus sesiones de boxeo de saco: duración total, calorías quemadas e intensidad promedio.
      </div>

      <div className="resumen24">
