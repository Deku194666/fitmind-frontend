...
import { FaBicycle, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroBicicleta2() {
  ...
  useEffect(() => {
    ...
    fetchRegistros();
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo==="bicicleta") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo25">🚴 Análisis de Bicicleta</p>

      <div className="intro">
        Analiza tus sesiones de ciclismo: duración total, calorías quemadas e intensidad promedio.
      </div>

      <div className="resumen25">
