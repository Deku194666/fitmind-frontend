...
import { FaWalking, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroCaminar2() {
  ...
  useEffect(() => {
    ...
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo === "caminar") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo22">🚶 Análisis de Caminatas</p>

      <div className="intro">
        Analiza tus sesiones de caminata: duración, calorías e intensidad.
      </div>
      ...
      <div className="graficas">
        <div className="chart-card scroll-x">
          <p className="subtitulo">⏱️ Tiempo de caminata (min)</p>
