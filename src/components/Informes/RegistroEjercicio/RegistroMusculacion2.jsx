...
import { FaDumbbell, FaClock, FaFire, FaChartLine, FaStar } from "react-icons/fa";
import "./RegistroMusculacion2.css";
...
function RegistroMusculacion2() {
  ...
  return (
    <div className="registro-container">
      <p className="titulo">💪 Análisis de Musculación</p>

      <div className="intro">
        Aquí puedes analizar tus sesiones de musculación: duración total,
        calorías quemadas e intensidad promedio. Visualiza tu progreso
        y detecta tu mejor rendimiento.
      </div>

      <div className="resumen">
        <MetricCard icon={<FaDumbbell size={28} color="#4f46e5" />}>
