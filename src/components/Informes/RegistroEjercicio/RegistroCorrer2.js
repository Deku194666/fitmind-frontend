...
function RegistroCorrer2() {
  ...
  useEffect(() => {
    ...
    const fetchRegistros = async () => {
      try {
        ...
        // ⛳️ Requiere endpoint backend: GET /api/correr/historial/:usuario_id
    ...
    // 🔁 Auto-refresco al registrar desde el módulo de correr
    const onNuevo = (e) => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <p className="Par1">📊 Análisis de Correr</p>
      <p className="Par2">Visualiza la evolución de tus sesiones de correr.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Tiempo (min) */}
        <Card>
          <div><p className="ParGrafico">⏱️ Tiempo de correr (min)</p></div>
