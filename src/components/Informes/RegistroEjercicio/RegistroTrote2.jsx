...
function RegistroTrote2() {
  ...
  useEffect(()=>{
    ...
    const onNuevo = e=>{ if(!e?.detail?.tipo || e.detail.tipo==="trote") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo22">🏃 Análisis de Trote</p>

      <div className="intro">
        Analiza tus sesiones de trote: duración, calorías e intensidad.
      </div>
