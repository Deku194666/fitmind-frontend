...
function RegistroBicicleta2() {
  ...
  useEffect(() => {
    ...
    const fetchRegistros = async () => {
      try {
        ...
        // ⛳️ Endpoint backend: GET /api/bicicleta/historial/:usuario_id
    ...
    // 🔁 Auto-refresco al registrar desde el módulo de bicicleta
    const onNuevo = (e) => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <p className="Par1">📊 Análisis de Bicicleta</p>
      <p className="Par2">Visualiza la evolución de tus salidas en bicicleta.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Tiempo (min) */}
        <Card>
          <div><p className="ParGrafico">⏱️ Tiempo de ciclismo (min)</p></div>
