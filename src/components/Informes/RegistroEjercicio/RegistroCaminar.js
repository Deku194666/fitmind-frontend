...
function RegistroCaminar() {
  ...
  return (
    <div className="ecnt-detail">
      ...
      <p className="p13">🚶 Caminar</p>

      <p className="p14">Introducción📌</p>
      <p className="p150">
        En esta sección podrás revisar y analizar tus sesiones de caminata. El módulo registra el tiempo total mediante
        un cronómetro y estima las calorías quemadas, para que hagas seguimiento de tu progreso de forma simple y visual.
      </p>

      <p className="p14">Qué encontrarás en este módulo📊</p>
      <ul className="p150" style={{ listStyleType: 'disc' }}>
        <li>Vista de la <strong>última caminata</strong> (tiempo, calorías y fecha).</li>
      ...
      <p className="p150">
        Todas tus caminatas quedan almacenadas de forma segura. Revísalas cuando quieras para identificar tendencias,
        planificar tus rutas y evaluar tu evolución en resistencia.
      </p>

      <p className="p150" style={{ marginTop: '2rem' }}>
        Mantén un seguimiento constante de tus caminatas para optimizar resultados y prevenir lesiones.
