...
import { FaRunning, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroCorrer2() {
  ...
  useEffect(() => {
    ...
    const onNuevo = e => { if (!e?.detail?.tipo || e.detail.tipo === "correr") fetchRegistros(); };
  ...
  return (
    <div className="registro-container">
      <p className="titulo22">🏃 Análisis de Correr</p>

      <div className="intro">
        Analiza tus sesiones de carrera: duración, calorías e intensidad.
      </div>
      ...
      <div className="graficas">
        ...
        <div className="chart-card scroll-x">
          <p className="subtitulo">⏱️ Tiempo de correr (min)</p>
