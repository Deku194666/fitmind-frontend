...
function RegistroYoga2() {
  ...
  useEffect(() => {
    ...
    const fetchRegistros = async () => {
      try {
        ...
        // ⛳️ Requiere endpoint backend: GET /api/yoga/historial/:usuario_id
    ...
    // 🔁 Auto-refresco al registrar desde el módulo de yoga
    const onNuevo = (e) => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <p className="Par1">📊 Análisis de Yoga</p>
      <p className="Par2">Visualiza la evolución de tus sesiones de yoga.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Tiempo (min) */}
        <Card>
          <div><p className="ParGrafico">⏱️ Tiempo de práctica (min)</p></div>
