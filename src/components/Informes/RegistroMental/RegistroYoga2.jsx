...
import { FaPrayingHands, FaClock, FaFire, FaStar } from "react-icons/fa";
...
function RegistroYoga2() {
  ...
  useEffect(()=>{
    ...
    const fetchRegistros=async()=>{
      ...
      } catch(err){console.error("Error al cargar yoga:",err);if(!cancel)setData([]);}
      finally{if(!cancel)setLoading(false);}
    };

    fetchRegistros();

    const onNuevo=(e)=>{if(!e?.detail?.tipo||e.detail.tipo==="yoga") fetchRegistros();}
  ...
  return (
    <div className="registro-container">
      ...
      <div className="intro">
        Visualiza la evolución de tus sesiones de yoga: duración total, calorías quemadas e intensidad promedio.
      </div>
